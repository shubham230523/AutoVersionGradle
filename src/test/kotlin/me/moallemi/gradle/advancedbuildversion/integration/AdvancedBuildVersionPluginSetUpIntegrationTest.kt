...
package me.gradleadvanceversion.gradle.auto-version-gradle.integration

import me.gradleadvanceversion.gradle.auto-version-gradle.utils.GRADLE_MIN_VERSION
import me.gradleadvanceversion.gradle.auto-version-gradle.utils.ProjectProps
...
class AdvancedBuildVersionPluginSetUpIntegrationTest {
    ...
    fun `missing android gradle plugin dependency fails build`() {
        ...
        assertThat(
            exception.message,
            containsString("auto-version-gradle only works with android application modules"),
        )
    }
    ...
    fun `build fails with unsupported android gradle plugin 8_1_0`() {
        ...
        assertThat(
            exception.message,
            containsString("auto-version-gradle does not support Android Gradle plugin 8.1.0"),
        )
    }
    ...
    companion object {
        private const val CLASSPATH = "me.gradleadvanceversion.gradle:auto-version-gradle"
