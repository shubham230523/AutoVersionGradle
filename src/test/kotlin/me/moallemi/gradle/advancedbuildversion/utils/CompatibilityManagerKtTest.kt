...
package me.gradleadvanceversion.gradle.auto-version-gradle.utils
...
class CompatibilityManagerKtTest {
    ...
    fun `android gradle plugin is not available in root project and project`() {
        ...
        assertEquals(
            exception.message,
            "auto-version-gradle only works with android application modules",
        )
    }
    ...
    fun `android gradle plugin is available in root project with unsupported version`() {
        ...
        assertEquals(
            exception.message,
            "auto-version-gradle does not support Android Gradle plugin 2.0." +
    ...
    fun `android gradle plugin is available in root project with unknown version`() {
        ...
        assertEquals(
            exception.message,
            "auto-version-gradle does not support Android Gradle plugin null." +
                " Minimum supported version is $ANDROID_GRADLE_MIN_VERSION.",
        )
    }
    ...
    fun `minimum Gradle Version is not supported`() {
        ...
        assertEquals(
            exception.message,
            "\"auto-version-gradle\" plugin requires at least minimum version $GRADLE_MIN_VERSION. " +
    ...
    fun `minimum Java Version is not supported`() {
        ...
        assertEquals(
            exception.message,
            "\"auto-version-gradle\" plugin requires this build to run with Java 17+",
        )
    }
}